...
namespace MediaBrowser.ApiInteraction
{
    ...
    /// </summary>
    public class ConnectHttpClient : IHttpClient
    {
        ...
        public ConnectHttpClient(ILogger logger)
        {
            Logger = logger;
        }
        ...
        public Stream Get(string url)
        {
            ...
            try
            {
                ...
                req.Headers.Add("X-Connect-UserToken", AuthToken);
        ...
        public string Post(string url, string contentType, string postContent)
        {
            ...
            using (var httpClient = new WebClient {Encoding = Encoding.UTF8})
            {
                ...
                httpClient.Headers.Add("X-Connect-UserToken", AuthToken);
